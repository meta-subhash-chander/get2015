...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements com.metacube.ConverterService {
    ...
    public com.metacube.Converter getConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.ConverterSoapBindingStub _stub = new com.metacube.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.ConverterSoapBindingStub _stub = new com.metacube.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://metacube.com", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://metacube.com", "Converter"));
        }
