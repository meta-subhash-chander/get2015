...
public class TowerOfHanoi {
	 ...
	 */
	public String towerofhanoi(String source, String temp, String destination,
			int numberofdisk) {
		if (numberofdisk == 1) {
			return "Move disk " + numberofdisk + " From " + source + " To "
					+ destination + "\n";
		} else {
			return towerofhanoi(source, destination, temp, numberofdisk - 1)
					+ "Move disk " + numberofdisk + " From " + source + " To "
					+ destination + "\n"
